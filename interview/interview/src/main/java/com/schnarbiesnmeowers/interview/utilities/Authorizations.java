 ...
 * adminself:update - admin can update only their admin data
...
public class Authorizations {
	...
	public static final String[] BASIC_USER_AUTH = { "data:select" };
	public static final String[] ADV_USER_AUTH = { "data:select", "self:lvl1" };
	public static final String[] PREMIUM_USER_AUTH = { "data:select", "self:lvl1", "self:lvl2" };
